...
async function ensureFaqColumns() {
  try {
    ...
    console.warn("No se pudo verificar columna status en faqs:", err);
  }
}
ensureFaqColumns();
...
// GET /api/faqs/categories - Listar categorías de FAQ (Público)
...
// POST /api/faqs/categories - Crear categoría de FAQ (Protegido por category.create o faq.create)
router.post(
  "/categories",
  authenticate,
...
// DELETE /api/faqs/categories/:id - Eliminar categoría FAQ (Protegido por category.delete)
router.delete(
  "/categories/:id",
  authenticate,
...
// GET /api/faqs - Listar FAQs guardadas en MySQL (Público para Landing)
...
// POST /api/faqs - Crear nueva FAQ (Protegido por faq.create)
router.post(
  "/",
  authenticate,
...
// PUT /api/faqs/:id - Editar FAQ (Protegido por faq.update)
router.put(
  "/:id",
  authenticate,
...
// PATCH /api/faqs/:id/status - Habilitar / Deshabilitar FAQ (Protegido por faq.update)
router.patch(
  "/:id/status",
  authenticate,
  requirePermission("faq.update"),
...
// DELETE /api/faqs/:id - Eliminar FAQ de MySQL (Protegido estrictamente por faq.delete)
router.delete(
  "/:id",
  authenticate,
